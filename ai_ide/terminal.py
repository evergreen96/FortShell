...
from ai_ide.models import TerminalEventWatch, TerminalSession, UsageMetrics
...
from ai_ide.terminal_inbox import render_terminal_inbox_entries, terminal_message_inbox_entry
from ai_ide.terminal_inspection_service import TerminalInspectionService, TerminalSessionInspection
from ai_ide.terminal_snapshots import TerminalInboxSnapshot, TerminalWatchSnapshot
...
if TYPE_CHECKING:
    ...
    from ai_ide.filtered_fs_backend import FilteredFSBackend
